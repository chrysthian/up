            ...
            <div className="flip-card-inner">
              <div className="flip-card-front">
                ...
                <div className="display-photo">
                  <Image src="/ch-2.jpeg" width={200} height={195} alt="Picture of Chrysthian Simão" />
                </div>
              </div>
              <div className="flip-card-back">
                <a href="https://www.linkedin.com/in/chrysthian-simao/" target="_blank">
                  <LinkedInIcon className="size-50" />
                </a>
                <a href="https://github.com/chrysthian" target="_blank">
                  <GitHubIcon className="size-50" />
                </a>
                <PictureAsPdfIcon className="size-50" />
              </div>
            </div>
          </div>
        </div>
